...
const sixSymptoms = ["nauseous", "breathing is difficult", "hearing is difficult", "seeing is difficult", "breathe", "hear", "see", "speak", "speaking is diffuclt", "concentrate", "smell"];